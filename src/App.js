...
function App() {
  ...
  return (
    <div className="App">
      ...
      <p className="nav__link"><NavLink to='/' exact>Home</NavLink></p>
      <p className="nav__link"><NavLink to='/todos'>Todos</NavLink></p>
      <p className="nav__link"><NavLink to='/album'>Album</NavLink></p>
