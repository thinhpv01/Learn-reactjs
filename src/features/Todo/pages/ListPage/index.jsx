...
function ListPage(props) {
    ...
    return (
        <div className="todo">
            ...
            <button style={{ display: 'block', cursor: 'pointer' }} onClick={addItem} className="todo__btn-add">
                Add
            </button>
            <div>
                <button className="todo__btn-show" onClick={handleShowAllClick}>
                    Show All
                </button>
                <button className="todo__btn-show" onClick={handleShowNewClick}>
                    Show New
                </button>
                <button className="todo__btn-show" onClick={handleShowCompletedClick}>
                    Show Completed
                </button>
            </div>
        </div>
